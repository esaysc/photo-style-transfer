...
class IconCard(QFrame):
    ...
    def __init__(self, icon: FluentIcon, parent=None):
        ...
        self.vBoxLayout.addWidget(self.iconWidget, 0, Qt.AlignHCenter) # type: ignore
        self.vBoxLayout.addSpacing(14)
        self.vBoxLayout.addWidget(self.nameLabel, 0, Qt.AlignHCenter) # type: ignore

        text = self.nameLabel.fontMetrics().elidedText(icon.value, Qt.ElideRight, 90) # type: ignore
...
class IconCardView(QWidget):
    ...
    def __initWidget(self):
        ...
        self.hBoxLayout.addWidget(self.infoPanel, 0, Qt.AlignRight) # type: ignore
