...
class ToolBar(QWidget):
    ...
    def __initWidget(self):
        ...
        # self.buttonLayout.addWidget(self.documentButton, 0, Qt.AlignLeft) # type: ignore
        # self.buttonLayout.addWidget(self.sourceButton, 0, Qt.AlignLeft) # type: ignore
        self.buttonLayout.addStretch(1)
        self.buttonLayout.addWidget(self.themeButton, 0, Qt.AlignRight) # type: ignore
        self.buttonLayout.addWidget(self.separator, 0, Qt.AlignRight) # type: ignore
        # self.buttonLayout.addWidget(self.supportButton, 0, Qt.AlignRight) # type: ignore
        self.buttonLayout.addWidget(self.feedbackButton, 0, Qt.AlignRight) # type: ignore
        self.buttonLayout.setAlignment(Qt.AlignVCenter | Qt.AlignLeft) # type: ignore
...
class ExampleCard(QWidget):
    ...
    def __initWidget(self):
        ...
        self.sourceWidget.setCursor(Qt.PointingHandCursor) # type: ignore
    ...
    def __initLayout(self):
        self.vBoxLayout.setSizeConstraint(QVBoxLayout.SetMinimumSize) # type: ignore
        self.cardLayout.setSizeConstraint(QVBoxLayout.SetMinimumSize) # type: ignore
        self.topLayout.setSizeConstraint(QHBoxLayout.SetMinimumSize) # type: ignore
        ...
        self.vBoxLayout.addWidget(self.titleLabel, 0, Qt.AlignTop) # type: ignore
        self.vBoxLayout.addWidget(self.card, 0, Qt.AlignTop) # type: ignore
        self.vBoxLayout.setAlignment(Qt.AlignTop) # type: ignore

        self.cardLayout.setSpacing(0)
        self.cardLayout.setAlignment(Qt.AlignTop) # type: ignore
        self.cardLayout.addLayout(self.topLayout, 0)
        self.cardLayout.addWidget(self.sourceWidget, 0, Qt.AlignBottom) # type: ignore
        ...
        self.bottomLayout.addWidget(self.linkIcon, 0, Qt.AlignRight) # type: ignore
        self.bottomLayout.setAlignment(Qt.AlignLeft | Qt.AlignVCenter) # type: ignore

    def eventFilter(self, obj, e):
        if obj is self.sourceWidget:
            if e.type() == QEvent.MouseButtonRelease: # type: ignore
                pass
...
class GalleryInterface(ScrollArea):
    ...
    def addExampleCard(self, title, widget, sourcePath: str, stretch=0):
        ...
        self.vBoxLayout.addWidget(card, 0, Qt.AlignTop) # type: ignore
        return card
