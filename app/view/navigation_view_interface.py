...
class PivotInterface(QWidget):
    ...
    def addSubInterface(self, widget: QLabel, objectName, text):
        ...
        widget.setAlignment(Qt.AlignTop | Qt.AlignLeft) # type: ignore
...
class TabInterface(QWidget):
    ...
    def initLayout(self):
        ...
        self.hBoxLayout.addWidget(self.controlPanel, 0, Qt.AlignRight) # type: ignore
        ...
        self.panelLayout.setAlignment(Qt.AlignTop) # type: ignore
    ...
    def onDisplayModeChanged(self, index):
        ...
        self.tabBar.setCloseButtonDisplayMode(mode) # type: ignore
    ...
    def removeTab(self, index):
        ...
        widget = self.findChild(QLabel, item.routeKey()) # type: ignore

        self.stackedWidget.removeWidget(widget) # type: ignore
