...
class DialogInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_flyout/dialog/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_flyout/message_dialog/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_flyout/custom_message_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            button,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_flyout/color_dialog/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_flyout/flyout/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            self.teachingButton,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PySide6/examples/dialog_flyout/teaching_tip/demo.py'
        )
    ...
    def showColorDialog(self):
        w = ColorDialog(Qt.cyan, self.tr('Choose color'), self.window()) # type: ignore
    ...
    def showLeftBottomTeachingTip(self):
        ...
        view.addWidget(button, align=Qt.AlignRight) # type: ignore
